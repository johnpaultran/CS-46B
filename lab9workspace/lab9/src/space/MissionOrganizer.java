...
public class MissionOrganizer implements Iterable<Mission>
{
	...
	{
		for(Mission n:expensiveMissions)
		{
			if(n.equals(m))
			{
				return true;
	...
	{
		ArrayList<Mission> iterated = new ArrayList<>();
		iterated.addAll(cheapMissions);
		iterated.addAll(expensiveMissions);
	...
	private final static Mission[]		TEST_MISSIONS =
	{
        ...
        new Mission("Sirius", 8E10f),
        new Mission("Apple", 13E17f),
        new Mission("Cat", 2E10f),
        new Mission("Dog", 1E18f)
	};
